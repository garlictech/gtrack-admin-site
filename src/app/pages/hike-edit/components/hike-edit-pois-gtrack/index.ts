...
export class HikeEditPoisGTrackComponent implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    ...
    combineLatest(
      ...
      .subscribe(([searchData, inStorePoiIds]: [IGeoSearchResponseItem, Array<string>]) => {
        if (searchData) {
    ...
    this.pois$
      ...
      .subscribe((pois: Array<IGTrackPoi>) => {
        // Refresh markers
