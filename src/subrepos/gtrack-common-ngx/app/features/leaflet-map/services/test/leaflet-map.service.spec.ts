...
import { ICenter, ILeafletMapConfig, EMarkerType } from '@common.features/leaflet-map/interfaces';
import { DEFAULT_LAYERS, DEFAULT_OVERLAY_LAYERS } from '@common.features/leaflet-map/constants';
...
import { featureName } from '@common.features/leaflet-map/store/state';
import { reducer } from '@common.features/leaflet-map/store';

describe('LeafletMapService', () => {
  let leafletMapService: LeafletMapService;
  let mapElement: HTMLDivElement;
  let center: ICenter;
  let mapConfig: ILeafletMapConfig;
  ...
  describe('Create map', () => {
    it('should create base map', (done) => {
      ...
      leafletMapService.createMap(
        'testMap', mapElement, center, DEFAULT_LAYERS, DEFAULT_OVERLAY_LAYERS, ['trails'], mapConfig
      );
  ...
  it('should register eventEmitters', (done) => {
    leafletMapService.createMap(
      'testMap', mapElement, center, DEFAULT_LAYERS, DEFAULT_OVERLAY_LAYERS, ['trails'], {}
    );
  ...
  it('should create featureGroup from GeoJSONObject', (done) => {
    ...
    const fetureGroup = leafletMapService.createFeatureGroupFromGeoJSONObject(mockGeoJSONObject, [GEOJSON_STYLES.bigBuffer]);
  ...
  it('should create markersGroup', (done) => {
    ...
    leafletMapService.createMap(
      'testMap', mapElement, center, DEFAULT_LAYERS, DEFAULT_OVERLAY_LAYERS, ['trails'], {spiderfier: {}}
    );
