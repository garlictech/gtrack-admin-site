import {
  Injectable, ComponentFactoryResolver, ComponentRef, Type, Injector, ApplicationRef
} from '@angular/core';
...
export class LeafletMarkerPopupService {
  ...
  public onUserMarkerClick = (marker: L.Marker, popupData: ILeafletMarkerPopupData, e: L.LeafletMouseEvent) => {
