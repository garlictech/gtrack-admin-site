...
export class Selectors {
  ...
  constructor(
    @Inject(EXTERNAL_DEEPSTREAM_DEPENDENCIES) externals,
    ...
    this.permissions = createSelector(selectFeature, this._externals.selectors.getUserRole, (state, role) => _.get(state, 'permissionRecord'));
